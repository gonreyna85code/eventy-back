...
app.use((req, res, next) => {
  ...
  res.header('Access-Control-Allow-Origin', 'https://eventy-main-4wt9jlomb-gonreyna85code.vercel.app'); // update to match the domain you will make the request from
  res.header('Access-Control-Allow-Credentials', 'true');
